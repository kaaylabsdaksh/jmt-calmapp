    ...
    <header className="bg-white px-2 sm:px-4 lg:px-6 py-3 border-b border-border">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        ...
        <div className="flex items-center gap-1 sm:gap-2 w-full sm:w-auto">
          {location.pathname !== "/onsite-projects/new" && location.pathname !== "/onsite-projects/vehicle-standards" && !customerDetailMatch && location.pathname !== "/quotes" && (
            <Button 
              variant="outline"
          ...
          {location.pathname !== "/manage-products" && location.pathname !== "/quotes" && (
            <>
