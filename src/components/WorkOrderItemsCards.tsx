...
export const WorkOrderItemsCards = ({ templateItems = [] }: WorkOrderItemsCardsProps) => {
  ...
  const handleViewDetails = (item: typeof allItems[0]) => {
    ...
    // Using specific values from the reference screenshot
    const workOrderData = {
      ...
      arrivalDate: item.created || "2024-01-15",
      ...
      details: {
        ...
        createdDate: item.created || "2024-01-15",
        departureDate: item.departure || "2024-02-05",
        originalLoc: "warehouse",
        destLoc: "main-office",
        serviceType: "express",
        technicalNotes: "Standard calibration required",
        comments: "Item ready for processing",
        poNumber: item.poNumber || "PO-2024-002",
        custId: "CUST-002",
        custSn: "C002",
        labCode: "LAB-3M",
