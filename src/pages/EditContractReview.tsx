...
export default function EditContractReview() {
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      <ModernTopNav />
      <main className="mx-auto max-w-[1600px] space-y-3 px-3 pb-24 pt-4 sm:px-5">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b pb-3">
          <div><h1 className="text-xl font-semibold text-foreground">Contract Review #{reviewId ?? "2"}</h1><p className="mt-0.5 text-xs text-muted-foreground">Review contract requirements, linked accounts, documents and approval details.</p></div>
        ...
        <div className="grid items-start gap-3 xl:grid-cols-[minmax(320px,35%)_minmax(0,65%)]">
          ...
          <div className="space-y-3">
            <Card>
              <CardHeader className="border-b bg-muted/30 px-3 py-2"><CardTitle className="text-sm">Contract Terms & Requirements</CardTitle></CardHeader>
              <CardContent className="space-y-2 px-3 pb-3">
