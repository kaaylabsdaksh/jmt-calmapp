...
export const AddInventoryTemplate = () => {
  ...
  return <div className="flex h-dvh min-h-0 flex-col bg-background"><ModernTopNav /><main className="flex min-h-0 flex-1 flex-col px-3 py-3 sm:px-4 lg:px-6"><section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border bg-card shadow-xs">
