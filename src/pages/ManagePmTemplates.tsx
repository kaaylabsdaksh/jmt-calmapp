...
const TemplateEditor = ({ template, isNew, pendingFile, fileInput, onFile, onChange, onCancel, onSave }: { template: PmTemplateRecord; isNew: boolean; pendingFile: string; fileInput: React.RefObject<HTMLInputElement>; onFile: (value: string) => void; onChange: <K extends keyof PmTemplateRecord>(key: K, value: PmTemplateRecord[K]) => void; onCancel: () => void; onSave: () => void }) => <section className="bg-card">
