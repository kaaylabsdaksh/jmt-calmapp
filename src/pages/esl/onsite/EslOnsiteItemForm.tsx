...
interface EslOnsiteItemFormProps {
  itemLabel: string;
  dropdownValue: string;
}

const EslOnsiteItemForm = ({ itemLabel, dropdownValue }: EslOnsiteItemFormProps) => {
      ...
      <main className="flex-1 px-4 py-3">
        <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-muted-foreground">{`Report # 00000.00-803810-${itemLabel}`}</span>
          </div>
          <div className="flex items-center gap-2">
              ...
              <div className="space-y-3">
                <Section title="General Information">
                  <div className="grid grid-cols-2 gap-2.5">
                    <Field label="Report #">
                      <ReadOnly value={`00000.00-803810-${itemLabel}`} />
                    </Field>
          ...
          <TabsContent value="details" className="mt-0">
            <Section title="Blanket Details">
              <p className="text-[11px] text-muted-foreground">
                {`Onsite ${itemLabel} test details (class, size, defects, results) are captured here.`}
              </p>
            </Section>
          </TabsContent>
        </Tabs>
...
export default EslOnsiteItemForm;
