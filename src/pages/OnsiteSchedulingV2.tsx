...
import { SchedulingDataProvider, useSchedulingData } from "@/context/SchedulingDataContextV2";
...
const OnsiteSchedulingV2 = () => (
  <SchedulingDataProvider>
    <SchedulingShellV2 />
  </SchedulingDataProvider>
);

export default OnsiteSchedulingV2;
