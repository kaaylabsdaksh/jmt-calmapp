      ...
      <div className="mx-auto w-full max-w-[1600px] space-y-4 px-4 py-5 sm:px-6">
        ...
        {!searching && records.length > 0 && (
          <div className="flex flex-col gap-4 pb-28">
            ...
            {/* RFID Assignment — floating card */}
            <div className="fixed bottom-6 right-6 z-30 w-[min(420px,92vw)] rounded-lg border border-border bg-card p-4 shadow-lg">
              ...
              {success ? (
                <div className="space-y-3 rounded-md border border-emerald-200 bg-emerald-50 p-3">
                  ...
                  <Button className="h-8 w-full bg-green-600 text-white hover:bg-green-700" onClick={clearSelection}>
                    Done
                  </Button>
                </div>
              ) : (
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Button variant="outline" className="h-9 flex-1" onClick={clearSelection} disabled={updating || !selected}>
